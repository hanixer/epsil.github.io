...
function format (html) {
  ...
  // fallback if any non-ASCII characters should somehow make their
  // way into the page). In general, though, we try to keep things as
  // safe as possible by returning raw ASCII and using numeric
  // character references for the rest.
  html = html.replace(/\n<\/code>\n<\/pre>/g, '</code>\n</pre>')
